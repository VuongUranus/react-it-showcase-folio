...
const Footer: React.FC = () => {
  return (
    <footer className="bg-black/30 py-8 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex flex-wrap gap-x-8 gap-y-2">
          ...
          <Link to="#" className="hover:text-primaryblue transition-colors">Contact</Link>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-8 pt-6 border-t border-gray-800 text-lightgray text-sm">
        <p>© 2025 Developer X. All rights reserved.</p>
      </div>
    </footer>
  );
};
