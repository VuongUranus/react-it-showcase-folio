      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <div className="flex gap-6">
            <a href="https://www.facebook.com/uranus.georgium" target='_blank' className="hover:text-primaryblue transition-colors">
              <Facebook />
            </a>
            <a href="https://x.com/onMinhVng10" target='_blank' className="hover:text-primaryblue transition-colors">
              <Twitter />
            </a>
            <a href="https://www.instagram.com/min_vuon/" target='_blank' className="hover:text-primaryblue transition-colors">
              <Instagram />
            </a>
            <a href="https://www.linkedin.com/in/doan-minh-vuong/" target='_blank' className="hover:text-primaryblue transition-colors">
              <Linkedin />
            </a>
            <a href="https://github.com/VuongUranus" target='_blank' className="hover:text-primaryblue transition-colors">
              <Github />
            </a>
          </div>
        </div>
